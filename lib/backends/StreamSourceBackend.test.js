...
describe('StreamSourceBackend', () => {
  ...
  describe('initialize', () => {
    it('should authenticate and fetch initial data', async () => {
      ...
      expect(backend.existingUrlsCache.size).toBe(2);
      expect(backend.existingUrlsCache.has('https://twitch.tv/user1')).toBe(true);
  ...
  describe('addStream', () => {
    ...
    it('should add a new stream successfully', async () => {
      ...
      expect(backend.existingUrlsCacheCache.has('https://twitch.tv/newuser')).toBe(true);
    });
  ...
  describe('urlExists', () => {
    ...
    it('should handle errors gracefully', async () => {
      backend.existingUrlsCache = null; // Force an error
  ...
  describe('sync', () => {
    ...
    it('should sync URLs', async () => {
      ...
      expect(backend.existingUrlsCache.size).toBe(2);
      expect(backend.existingUrlsCache.has('https://twitch.tv/newstream')).toBe(true);
  ...
  describe('fetchExistingStreams', () => {
    ...
    it('should handle paginated results', async () => {
      ...
      await backend.fetchExistingStreams();

      expect(backend.existingUrlsCache.size).toBe(3);
    ...
    it('should handle empty response', async () => {
      ...
      expect(backend.existingUrlsCache.size).toBe(0);
    });
  });
